...
## Procedure
1. Exported Google Sheet corresponding to Google Form survey as [`student_responses.csv`](https://github.com/maxinehsu/summary-visualizations/blob/main/student_responses.csv).
